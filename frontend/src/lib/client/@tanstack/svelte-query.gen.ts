...
export const getUserBalancesBalancesGetQueryKey = (options?: Options<GetUserBalancesBalancesGetData>) => createQueryKey('getUserBalancesBalancesGet', options);

export const getUserBalancesBalancesGetOptions = (options?: Options<GetUserBalancesBalancesGetData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getUserBalancesBalancesGet({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getUserBalancesBalancesGetQueryKey(options)
    });
};
